...
function resetSteelCraftBrand(){ localStorage.setItem(brandKey, JSON.stringify(brandDefaults)); localStorage.setItem(enabledKey, JSON.stringify(defaultEnabledPortals)); sessionStorage.removeItem(developerUnlockKey); }
...
function lockDeveloperRoom(){ localStorage.setItem(developerLockedKey, 'true'); lockBrandRoom(); }
...
function App(){
  ...
  if (isDeveloperPath && !user && !isDeveloperLocked()) {
